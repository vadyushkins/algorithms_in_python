...
def create_list(data: List[int]) -> SinglyLinkedList:
...
def evaluate_operations(operations: List[str]) -> SinglyLinkedList:
    result = SinglyLinkedList()
...
def compare_lists(a: SinglyLinkedList, b: SinglyLinkedList) -> bool:
    cur_a = a.head
    cur_b = b.head
